      ...
      >
        ...
        <div className="space-y-6 relative z-10 max-w-lg">
          <h1 className="text-[2.8rem] xl:text-[3.8rem] font-extrabold text-white leading-[1.08] tracking-tight">
            <span className="block whitespace-nowrap">Donde la{" "}<span className="bg-gradient-to-r from-[hsl(145,60%,45%)] via-[hsl(165,55%,48%)] to-[hsl(180,50%,50%)] bg-clip-text text-transparent drop-shadow-[0_0_20px_hsla(155,60%,45%,0.3)]">estrategia</span></span>
            <span className="block whitespace-nowrap bg-gradient-to-r from-[hsl(170,55%,48%)] via-[hsl(185,50%,50%)] to-[hsl(200,55%,55%)] bg-clip-text text-transparent drop-shadow-[0_0_20px_hsla(185,55%,50%,0.3)]">y la cultura</span>
